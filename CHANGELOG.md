...
### Fixed
- Fixed a bug that would occur in new installations of Usher with no previous Usher migrations. `Usher.Migration` did not account for tables with no version comments.
